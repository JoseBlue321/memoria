                                                    ...
                                                    <div class="row align-items-start justify-content-start">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                              ...
                                                              <textarea class="form-control" name="autores" id="" rows="3" placeholder=""></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row align-items-start justify-content-start">
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="form-group">
                                                          ...
                                                          <input type="number" name="citas" id="" class="form-control" placeholder="" aria-describedby="helpId">
